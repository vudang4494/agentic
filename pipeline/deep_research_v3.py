...
Usage:
  python3 pipeline/deep_research_v3.py --topic "Attention Mechanisms" --out-name attn_v3
  python3 pipeline/deep_research_v3.py --topic "Attention Mechanisms" --out-name attn_v3 --no-smoke
"""
...
def run_v3(topic, out_name=None, n_chapters=None, sections_per_chapter=None,
    ...
    run_dir = ROOT / "output/runs" / out_name
