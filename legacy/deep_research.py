...
Live orchestrator = pipeline/deep_research_v3.py (see CLAUDE.md). This v2 path is
...
try:
    sys.path.insert(0, str(Path(__file__).parent.parent))  # legacy/ -> repo root (research/ post-reorg)
