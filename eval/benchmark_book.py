...
Usage:
    python3 eval/benchmark_book.py <run-name-or-dir>
    python3 eval/benchmark_book.py _struct_verify
"""
import json
import os
import re
...
def main():
    if len(sys.argv) < 2:
        sys.exit("usage: python3 eval/benchmark_book.py <run-name-or-dir>")
